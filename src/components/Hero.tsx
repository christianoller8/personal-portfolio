    ...
    <div className="max-w-7xl md:px-8 lg:px-14">
      <div className="relative flex w-full items-center">
        <div className="flex max-w-[700px] flex-1 flex-col gap-4 md:gap-6">
          <div className="relative flex h-20 w-20 flex-none cursor-pointer items-center justify-center rounded-full  bg-indigo-400/20 shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:bg-zinc-900/40 dark:ring-0 md:h-24 md:w-24">
            <Image
              src={myLogo}
              alt="photo profile"
            />
          ...
          <p className="text-justify text-base font-normal leading-7 text-zinc-100 dark:text-zinc-400 md:pr-10 md:text-lg">
            I’m a Software Developer with more than 2 years of experience.
            Digital explorer, code creator and continuous learning enthusiast.
            I immerse myself in the universe of web and mobile development, where every line of code is an adventure.
          </p>
        </div>
      </div>
      <div className="mt-6 flex gap-6 text-zinc-400">
        ...
        <a
          href="mailto:christianoller8@gmail.com"
          className="group -m-1 p-1"
