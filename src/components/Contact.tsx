...
function Contact () {
  ...
  return (
    <div className='mt-16 flex flex-col gap-7 md:flex-row'>
      <h2 className='mr-4 flex h-max flex-col items-center self-center pb-4 pr-4 text-4xl font-bold leading-10 tracking-tighter text-zinc-100 dark:text-zinc-100 sm:pb-8 lg:px-14 lg:text-7xl'>
        Contact me!
          ...
          : (
            <div className='mt-6 flex flex-wrap gap-4'>
              ...
              <button
                ...
                type='submit'
                className='mt-2 inline-flex flex-none items-center justify-center gap-2 rounded-md bg-emerald-500/90 px-4 py-2 text-base font-bold text-zinc-50 outline-offset-2 transition-all duration-300 hover:bg-emerald-600 active:bg-emerald-800 active:text-zinc-100/90 active:transition-none dark:bg-emerald-500 dark:text-zinc-100 dark:hover:bg-emerald-600 dark:active:bg-emerald-800 dark:active:text-zinc-100/90'
              >
                Get in Touch
              </button>
            </div>
