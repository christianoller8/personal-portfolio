    ...
    <Container>
      <div className="sm:px-8">
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 md:flex-row lg:px-8">
            ...
            {state.succeeded ? (
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                ...
                <button
                  ...
                  type="submit"
                  className="mt-2 inline-flex flex-none items-center justify-center gap-2 rounded-md bg-emerald-500 px-4 py-2 text-base  font-bold text-zinc-100 outline-offset-2 transition hover:bg-emerald-600 active:bg-emerald-800 active:text-zinc-100/90 active:transition-none dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:active:bg-emerald-800 dark:active:text-zinc-100/90"
                >
                  Get in Touch
                </button>
              </div>
          ...
          <div className="ml-2 mt-6 md:mt-0 md:pt-8 lg:pr-20">
            <ul className="flex flex-col gap-4 md:gap-6" role="list">
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <span className="ml-4">christianoller.dev@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
